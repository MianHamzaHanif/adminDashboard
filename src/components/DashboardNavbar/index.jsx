...
const DashboardNavbar = ({ toggleSidebar }) => {
    ...
    return (
        <nav className="navbar navbar-expand-lg navbar-light dashboard-navbar position-fixed">
            <div className="container-fluid d-flex align-items-center justify-content-between">
                <div className="d-flex align-items-center gap-3">
                    <img src={logo} alt="Logo" style={{ width: 60, height: 40, borderRadius: '50%' }} />
                    <h5 style={{ margin: 0, color: '#7b4fe2' }}>Apollo Mass Dashboard</h5>
                </div>
