...
import { updateAllowedUser, getOwnerAddress } from '../../blockchain/instances/contract';
...
const AllowedUsers = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        setLoading(true);
        try {
            await updateAllowedUser(userAddress, status);
    ...
    return (
        <div style={{ minHeight: '80vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#f8f9fa' }}>
            <form onSubmit={handleSubmit} style={{
                ...
                <h2 style={{ marginBottom: 0, color: '#2b2b2b' }}>Update Allowed User</h2>
                <input
